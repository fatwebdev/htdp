...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise_027) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (attendees ticket-price)
  (- PEOPLE-COUNT-ON-BASE-TICKET-PRICE
     (* (- ticket-price BASE-TICKET-PRICE) COEFFICIENT)))